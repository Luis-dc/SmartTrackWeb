function formatDate(value) {
  ...
  function InteresadosDetailTable({ items = [], loading }) {
    if (loading) {
      return (
        <div className="card border-0 shadow-sm rounded-4">
          <div className="card-body">
            <p className="mb-0">Cargando detalle...</p>
          </div>
        </div>
      )
    }
    ...
    if (!items.length) {
      return (
        <div className="card border-0 shadow-sm rounded-4">
          <div className="card-body">
            <p className="mb-0">No se encontraron interesados para este ER.</p>
          </div>
        </div>
      )
    }
  ...
  export default InteresadosDetailTable